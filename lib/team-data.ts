...
export const leadership: TeamMember[] = [
  {
    ...
    bio: 'Visionary Founder and Chief Executive Officer of Mega Wake Up International Outreach and FCT Heritage Multi-Purpose Cooperative. Born on 25th May, 1970 in Anua, Essien Udom Local Government Area, Akwa Ibom State. Dr. Bassey holds a Doctorate Degree and B.Sc from the University of Abuja (2012-2016), having previously attended Modern Vocational School Aka-offat (SSCE, 1982-1989) and Holy Child Convent Anua (FSLC, 1974-1981). As Zonal Coordinator for North Central Agro Allied Cooperative, she leads the organization\'s mission to provide emergency relief quickly, effectively, and without impartiality to communities affected by poverty. Her philosophy centers on providing longer-term solutions by investing in humanity and mobilizing strategic resources. Dr. Bassey has initiated numerous programs that have touched lives and impacted positive thinking through organizing entrepreneurial schemes and various skills acquisition programs. Her extraordinary commitment to charity has enabled many lives to move from despair and incapacitation to glorious living. She applies frameworks of fantastic service to practice organizational behavior for humanitarian excellence. Recognized with Awards of Excellence by IMC and Golden Bridge. Fluent in English and Ibibio. Contact: inemisitbassey36@yahoo.com | 08033780633 | No. 26 Market Road, Ikot Ekpene, Akwa Ibom State.',
