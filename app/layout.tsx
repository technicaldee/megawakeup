...
export const metadata: Metadata = {
  ...
  description: 'Mega Wake Up International (MEWI) is an indigenous Nigerian non-profit empowering communities across Nigeria through education, skills development, sustainable agriculture, healthcare, economic empowerment, social protection, and climate resilience.',
  keywords: [
    'NGO Nigeria',
    'humanitarian aid',
    'poverty alleviation',
    ...
    'women empowerment',
    'youth development',
    'safeguarding and social inclusion',
  ...
  openGraph: {
    ...
    description: 'Empowering communities across Nigeria through education, sustainable agriculture, healthcare, economic empowerment, and climate resilience.',
    images: [
      {
        url: logoUrl,
        width: 1200,
